...
export const messageServerUrl: string = 'https://api.psglinkedin.tech/message';
export const messageServerWebSocketUrl: string = 'wss://api.psglinkedin.tech/message/ws';
